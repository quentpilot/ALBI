        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-10 wow fadeIn" data-wow-delay="0.3s">
              <h1 class="text-upper">Software Landing Page <?= $items_content ?></h1>
              ...
              <img src="<?= site_url('assets/public/public_master/images/software-img.png') ?>" class="img-responsive" alt="home img">
            </div>
            <div class="col-md-1"></div>
          </div>
        </div>
